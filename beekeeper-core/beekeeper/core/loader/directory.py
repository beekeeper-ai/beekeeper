...
def _loading_default_supported_readers():
    try:
        from beekeeper.loader.file import DocxReader, HTMLReader, PDFReader
    except ImportError:
        raise ImportError(
            "beekeeper-loader-file package not found, please install it with `pip install beekeeper-loader-file`",
        )
