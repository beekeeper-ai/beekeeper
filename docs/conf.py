...
sys.path.insert(0, os.path.abspath("../beekeeper-core"))
base_ext_dir = os.path.abspath('../beekeeper-extensions')

# Add every subdirectory that contains a `beekeeper/` package to sys.path from extensions
for root, dirs, files in os.walk(base_ext_dir):
    if 'beekeeper' in dirs:
        beekeeper_path = os.path.join(root)
        sys.path.insert(0, beekeeper_path)
...
html_theme_options = {
    ...
    "footer_icons": [
        {
            "name": "PyPI",
            "url": "https://pypi.org/project/beekeeper/",
            "html": """
        ...
        {
            "name": "GitHub",
            "url": "https://github.com/leonardofurnielis/beekeeper",
            "html": """
